...
`<LoadingButton btnText="Submit" isLoading={loading} onClick={handleClick} height="h-14" width="w-24" borderRadius="rounded-md"/>`;

export { loadingButtonCode, loadingButtonUsage }